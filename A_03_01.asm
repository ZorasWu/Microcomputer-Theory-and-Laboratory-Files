...
ORG 13H ; external 0 interrupt vector
JMP ext0ISR ; jump to the external 0 ISR
ORG 01BH ; timer 0 interrupt vector
JMP timer0ISR ; jump to timer 0 ISR
ORG 30H ; main program starts here
main:
SETB IT1 ; set external 0 interrupt as edge-activated
SETB EX1 ; enable external 0 interrupt
CLR P0.7 ; enable DAC WR line
MOV TMOD, #2 ; set timer 0 as 8-bit auto-reload interval timer
MOV TH1, #-50 ; | put -50 into timer 0 high-byte - this reload value, 
